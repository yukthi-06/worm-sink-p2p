...
// .wrangler/tmp/bundle-X9eRzq/checked-fetch.js
...
// .wrangler/tmp/bundle-X9eRzq/strip-cf-connecting-ip-header.js
...
async function saveSessionData(env, code, data) {
  ...
  if (env.SESSIONS) {
    await env.SESSIONS.put(code, serialized, { expirationTtl: 3600 });
  } else {
...
var signaling_server_cloudflare_default = {
...
// .wrangler/tmp/bundle-X9eRzq/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = signaling_server_cloudflare_default;
...
// .wrangler/tmp/bundle-X9eRzq/middleware-loader.entry.ts
