...
const WORDS = [
  ...
  "ritual", "rival", "river", "road", "roast", "robot", "robust", "rock", "rocket", "romance",
  "roof", "rookie", "room", "rose", "rotate", "rough", "round", "route", "royal", "rubber",
  "rude", "rug", "rule", "run", "runway", "rural", "sad", "saddle", "sadness", "safe",
  "safety", "sage", "sail", "salad", "salmon", "salon", "salt", "salute", "same", "sample",
  "sand", "satisfy", "saturday", "sauce", "sausage", "save", "say", "scale", "scan", "scare",
  "scatter", "scenario", "scene", "scent", "scheme", "school", "science", "scissors", "scooter", "scope",
  "score", "scout", "scrap", "screen", "screw", "script", "scrub", "sea", "search", "season",
  "seat", "second", "secret", "section", "sector", "secure", "security", "seed", "seek", "segment",
  "select", "sell", "seminar", "senior", "sense", "sentence", "september", "serenity", "series", "serious",
  "servant", "serve", "service", "session", "settle", "setup", "seven", "shadow", "shaft", "shallow",
  "shame", "shape", "share", "shark", "sharp", "shawl", "she", "shed", "shell", "sheriff",
  "shield", "shift", "shine", "ship", "shiver", "shock", "shoe", "shoot", "shop", "short",
  "shoulder", "shove", "show", "shower", "shrub", "shrug", "shuffle", "shun", "shutter", "shy",
  "sibling", "sick", "side", "siege", "sight", "sign", "silent", "silk", "silly", "silver",
  "similar", "simple", "since", "sing", "siren", "sister", "situate", "six", "size", "skate",
  "sketch", "ski", "skill", "skin", "skirt", "skull", "sky", "slate", "sleep", "slice",
  "slide", "slight", "slim", "slogan", "slot", "slow", "slum", "slump", "small", "smart",
  "smash", "smell", "smile", "smoke", "smooth", "snack", "snake", "snare", "sneeze", "sniff",
  "snow", "soap", "soccer", "social", "sock", "soda", "soft", "solar", "soldier", "solid",
  "solve", "some", "song", "soon", "sorry", "sort", "soul", "sound", "soup", "source",
  "south", "space", "spare", "spatial", "speak", "special", "speed", "spell", "spend", "sphere",
  "spice", "spider", "spike", "spin", "spirit", "spit", "spoil", "sponsor", "spoon", "sport",
  ...
  "stool", "store", "storm", "story", "strap", "straw", "stray", "street", "strength", "stretch",
  "strike", "string", "strip", "strive", "strong", "struggle", "student", "studio", "study", "stuff",
  "stumble", "style", "subject", "submit", "subway", "success", "such", "sudden", "suffer", "sugar",
  "suggest", "suit", "summer", "sun", "sunday", "sunny", "sunset", "super", "supply", "support",
  ...
  "then", "theory", "there", "they", "thing", "think", "third", "this", "thought", "three",
  ...
  "tower", "town", "toy", "track", "trade", "traffic", "tragedy", "train", "transfer", "trap",
  "trash", "travel", "tray", "treat", "tree", "trend", "trial", "tribe", "trick", "trigger",
  "trim", "trio", "trip", "trophy", "trouble", "truck", "true", "truly", "trumpet", "trust",
  "truth", "try", "tube", "tuesday", "tuition", "tumble", "tuna", "tundra", "tunnel", "turkey",
  ...
  "velvet", "vendor", "venture", "venue", "verb", "verdict", "verify", "version", "very", "vessel",
  ...
  "way", "wealth", "weapon", "wear", "weasel", "weather", "web", "wedding", "wednesday", "weekend",
  "weekly", "weigh", "weird", "welcome", "west", "wet", "whale", "what", "wheat", "wheel",
  "when", "where", "whether", "which", "while", "whisper", "whistle", "who", "whole", "why",
  "wide", "width", "wife", "wild", "will", "win", "wind", "window", "windy", "wine",
  "wing", "wink", "winner", "winter", "wire", "wisdom", "wise", "wish", "witness", "wolf",
  "woman", "wonder", "wood", "wool", "word", "work", "world", "worry", "worth", "wrap",
  "wreck", "wrestle", "wrist", "write", "wrong", "yard", "year", "yellow", "yes", "yesterday",
  "yet", "yield", "you", "young", "your", "yourself", "youth", "zebra", "zero", "zone", "zoo"
];

// Fallback in-memory session store for workers with no KV configured
...
async function saveSessionData(env, code, data) {
  ...
  if (env.SESSIONS) {
    ...
    // Cleanup simple memory sessions older than 1 hour
    setTimeout(() => {
